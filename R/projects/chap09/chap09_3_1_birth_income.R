...
# 이상치 처리 하기
welfare_income$birth <- ifelse(welfare_income$birth == 9999,
                               NA, welfare_income$birth)
...
# col 파라미터로 성별 그래프 나눠 그릴 수 있음
ggplot(data = age_income2, aes(x = age,
                               y = mean_income, col = sex)) +
  geom_line()
